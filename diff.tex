...
%DIF DEL old.tex           Tue Jul 21 13:43:11 2026
%DIF ADD EinsteinTDE.tex   Tue Jul 21 13:44:13 2026
...
\begin{figure}
\centering
 \DIFdelbeginFL %DIFDELCMD < \includegraphics[scale=0.4]{StarkGas}
%DIFDELCMD <  %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[scale=0.6]{StarkGas}
...
n-spherical }\DIFdelend \DIFaddbegin \DIFadd{non-spherical }\DIFaddend electrons would, in principle, behave differently from spherical ones, the absence of a definite electron model was taken to be a defect rather than a virtue \citet{Einstein1907a}, however, was not particularly impressed by this objection. He famously emphasized that relativity was not a complete theory, but merely imposed kinematical constraints on admissible theories. Einstein did not develop a theory of the electron, but modified the equations of motion of a charged particle in general so as to make them Lorentz invariant. After coming across \citets{Stark1906} paper toward the end of 1906, Einstein may have quickly realized that this work opened the possibility of a more direct test of the new kinematics itself, without recourse to electron dynamics. He addressed this issue in a paper submitted on \datemy{3}{3}{1907}. 
...
\citep[131\psq]{Einstein1910} }\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite[131\psq]{Einstein1910} }\hskip0pt%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \section*{\DIFadd{Real and Apparent. Einstein's Last Remarks on the }\TDE}
\DIFaddend %
...
\DIFdel{is entirely a consequence of the relativistic transformation of time , that is, of time dilation}\DIFdelend \DIFaddbegin \DIFadd{The same emission process involves the same count \(N\) of completed oscillations. What changes is not this count, but the time interval with respect to which it is evaluated, the fact that the same \(N\) is referred to different time intervals in the two inertial descriptions}\DIFaddend :
\[
\Delta t = \gamma\,\Delta t'.
\]
\end{enumerate}
...
\citepp{Einstein1921}{Einstein1923}{Einstein1924}{Einstein1926}{Einstein1949}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citepp{Einstein1921}{Einstein1923}{Einstein1924}{Einstein1926}}\hskip0pt%DIFAUXCMD
}\DIFaddend . From a more fundamental standpoint, \DIFdelbegin \DIFdel{clocks may be }\DIFdelend \DIFaddbegin \DIFadd{atomic clocks should }\DIFaddend regarded as particular solutions of the underlying dynamical equations, with their behavior fixed by invariant parameters of the theory. Such parameters determine characteristic frequencies\footnote{For example, a mass parameter fixes the Compton frequency $\nu_C=\hfrac{mc^2}{h}$.}, which in turn set the intrinsic periodicity of the admissible solutions. If the fundamental theory is Lorentz invariant, the same periodic solutions must occur in \DIFdelbegin \DIFdel{all co-moving }\DIFdelend \DIFaddbegin \DIFadd{inertial }\DIFaddend systems, with the \DIFdelbegin \emph{\DIFdel{same}} %DIFAUXCMD
...
\DIFdel{an underlying classical kinematics. At this point, however, it becomes unclear what a genuinely }\DIFdelend \DIFaddbegin \DIFadd{Ives does not even mention special relativity and presents his result as evidence that the change of frequency }\q{predicted by the Larmor-Lorentz theory is verified} \DIFadd{\mbox{%DIFAUXCMD
\citepp[225]{Ives1938}[see][374]{Ives1941-05}}\hskip0pt%DIFAUXCMD
. Not surprisingly, Einstein replied rather tersely to Ives' announcement that }\tDe \DIFadd{has been finally confirmed}\footnote{\letteraea{Ives}{Einstein}{24}{6}{1938}[53-549]\DIFadd{; }\letteraea{Einstein}{Ives}{4}{8}{1938}[80-269]}\DIFadd{. 
}
...
\DIFdelend \DIFaddbegin \DIFadd{. If one wishes to provide a proper dynamical explanation of the frequency shift itself, that this would amount to a full-blown return to the ether theory of Larmor and Lorentz as \mbox{%DIFAUXCMD
\citet{Ives1947} }\hskip0pt%DIFAUXCMD
suggested. The case of the }\tDe \DIFadd{shows  with particular clarity that, from a historical point of view, Einstein’s call for a dynamical explanation of the behavior of clocks was not intended to be a call for a dynamical explanation of time dilation. From a theoretical point of view, however, the pursuit of such an explanation }\emph{\DIFadd{within}} \sr \DIFadd{can of course proceed on a different basis, without appealing to Einstein’s authority}\footnote{\DIFadd{As is well-known, \mbox{%DIFAUXCMD
...
\citepp{Brown2001}[sec.~1.4]{Brown2005}}\hskip0pt%DIFAUXCMD
...
. The crucial question in the dynamical/kinematical debate is ultimately how this }\s{\emph{all}} \DIFadd{is to be understood: as a remarkable coincidence among otherwise independent dynamical laws, or as a requirement imposed on any admissible dynamical law.}}
\DIFaddend 
